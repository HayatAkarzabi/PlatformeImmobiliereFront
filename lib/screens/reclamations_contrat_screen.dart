    ...
    return Card(
      ...
      child: ListTile(
        leading: Container(
          ...
          child: Icon(
            reclamation.typeRec == 'URGENT' ? Icons.warning : Icons.info,
        ...
        trailing: Icon(
          reclamation.priorite == 'HAUTE' ? Icons.whatshot :
          reclamation.priorite == 'MOYENNE' ? Icons.priority_high : Icons.low_priority,
          color: reclamation.typeColor,
        ),
      ),
    );
  }
    ...
    return Scaffold(
      ...
      body: _isLoading
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) => _buildReclamationCard(_reclamations[index]),
        ),
      ),
    );
  }
